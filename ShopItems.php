...
<body>
    ...
    <input type="text" class="d-none" id="hfObject" name="hfObject" placeholder="hfObject" value="<?php if (isset($_POST['hfObject'])) print $_POST['hfObject']; ?>">
    <nav class="navbar">
